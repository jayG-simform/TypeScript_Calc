...
// display Input
export let input = document.getElementById("displayInput")! as HTMLInputElement;

// display output
export var output = document.getElementById('output_display')! as HTMLInputElement;

// memory array 
const memory: any[] = [];

export const pI: string | unknown = Math.PI;
export const e: string | unknown = Math.E;

// display memory div 
export const memorySection: HTMLElement | null = document.getElementById("memory-show") as HTMLElement | null;
...
chng1?.addEventListener('click',function(){
    chng.changes();
});
